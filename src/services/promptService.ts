...
export class PromptService {
  static getDefaultLiveSuggestionPrompt(): string {
    return DEFAULT_LIVE_SUGGESTION_PROMPT;
  }

  static getDefaultDetailedAnswerPrompt(): string {
    return DEFAULT_DETAILED_ANSWER_PROMPT;
  }

  static getDefaultChatPrompt(): string {
    return DEFAULT_CHAT_SYSTEM_PROMPT;
  }

  static parseSuggestionsResponse(response: string): Array<{
    title: string;
    preview: string;
    type: string;
  }> {
